...
- Day 1: Scope expanded to 3 personas (Solo Mover, Couple, Pro) and 2 platforms (desktop web, mobile AR)
- Roadmap: Solo Mover desktop = prototype spine; Couple branch = 3–4 frame addition; Pro flow and full AR = case study documentation only
...
- Participant background data: Day 1 notes on the 11 identified participants are needed before Day 5 to finalize the 5 session slots against Solo Mover screening criteria (recently moved or about to move; no professional design background)
- Springboard rubric: Confirm specific grading criteria for the case study against course materials before Phase 5 begins
